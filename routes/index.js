...
module.exports = function (app) {
    ...
    app.get("/forgot-password-email",
        generatePasswordResetEmailMW(objectRepository),
        renderMW(objectRepository, "forgot-password-email")
    );
    app.get("/reset-password",
        checkPasswordResetTokenMW(objectRepository),
        renderMW(objectRepository, "reset-password")
    );
    ...
    app.use("/cars",
        authMW(objectRepository),
        cars(objectRepository)
    );
    app.use("/rents",
        authMW(objectRepository),
        rents(objectRepository)
    );
    app.use("/clients",
        authMW(objectRepository),
        clients(objectRepository)
    );
